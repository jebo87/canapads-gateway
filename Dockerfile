...
#docker run --rm --name makako-gateway --network makako_network -v $(pwd)/config:/makako-gateway/bin/config -p 8087:8087 registry.gitlab.com/jebo87/makako-gateway:0.1
#docker run -d --name makako-gateway --network makako_network -v $(pwd)/config:/makako-gateway/bin/config -p 8087:8087 registry.gitlab.com/jebo87/makako-gateway:0.1